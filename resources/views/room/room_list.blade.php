                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="table_data" class="result_append">
                            @include('room.room_row', ['room' => $room])
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", "input[name=user_status]", function() {
                ...
                $.get("<?= url('room/active-inactive') ?>" + "/" + attrfr, function(data) {
            ...
            $(document).on("click", ".openDetailModal", function() {
                start_loader()
                var attrfr = $(this).attr("eid");
                $.get("<?= url('room/show') ?>" + "/" + attrfr, function(data) {
            ...
            $(document).on("blur", ".search", function() {
                ...
                start_loader();
                $.get("<?= url('room/search') ?>", searchParams, function(data) {
