                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="table_data" class="result_append">
                            @include('booking.booking_report_row', [
                                'booking' => $booking,
                            ])
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            ...
            function init_from_date() {
                $('#from_date').datepicker({
                    ...
                    start_loader();
                    $.get('{{ url('booking/booking_report_search') }}', searchParams, function(data) {
                        // console.log(data);
                        if ($('#from_date').val() == '') {
            ...
            $(document).on('click', '.export_csv', function() {
                ...
                window.location = '<?= url('/booking/booking_report_export') ?>?' + params;
            })
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page) {
                ...
                start_loader();
                $.ajax({
                    url: "<?= url('/booking/booking_report_search?page=') ?>" + page,
                    type: "GET",
                    data: searchParams,
