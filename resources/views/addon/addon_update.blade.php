                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= $addon->title ?>" name="title" id="title"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= $addon->price ?>" name="price" id="price"
        ...
        $(document).ready(function() {
            $("#form").submit(function(e) {
                ...
                if (isValid) {
                    start_loader();
                    $.ajax({
                        url: "<?= url('addon') ?>/edit" + "/" + "<?= $addon->addon_id ?>",
                        type: "POST",
                        data: formData,
                        cache: false,
                        contentType: false,
