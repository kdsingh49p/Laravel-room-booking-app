                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $new_patient_id }}" type="text" readonly="true"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="select2_c patient_disease_id form-control"
                                                ...
                                                <option value="<?= $item->disease_id ?>"><?= $item->title ?></option>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="control-label">Patient Age <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" name="patient_age" id="patient_age" min="1" max="200"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Patient Mobile <span
                                                    class="text-danger">*</span></label>
                                            <input onkeypress="javascript:return validateNumber(event)" type="tel" max="10"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Patient Address <span
                                                    class="text-danger">*</span></label>
                                            <textarea type="text" rows="3" name="patient_address" id="patient_address"
                                                class="form-control patient_address"></textarea>
                                            <small class="has_error"> This Field is Required </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-actions">
                                            <button style="    margin-top: 30px;" type="submit"
                                                class="btn btn-success save"> <i class="fa fa-check"></i> Save</button>
