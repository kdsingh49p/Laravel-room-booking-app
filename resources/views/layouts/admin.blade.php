...
<head> 
    ...
    <link rel="stylesheet" href="{{asset ('admin-assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css')}}">
                        ...
                        <div class="category-content">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <span class="media-heading text-semibold">Deals</span>
                                    <div class="text-size-mini text-muted">
                                        <i class="icon-pin text-size-small"></i> &nbsp; Deals                                    </div>
                                </div>
                            ...
                            <ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li ><a id="button1" href="{{ url('/admin/merchant/create') }}">Merchant Master</a></li>
 
                                        <li><a id="button1" href="{{url('/admin/event/create')}}">Event Create</a></li>
  
                                        <li><a id="button1" href="{{url('/admin/category/create')}}">Category Master</a>
                                           
                                        </li>
                                         

                                        <li><a id="button1" href="{{url('/admin/customer/index')}}">Customer Master</a>
                                            <ul>
                                                 <li class="<?= ($route=='admin/customer/index') ? "active" : "" ?>"><a href="{{url('/admin/customer/index')}}">View All</a></li>
                                            </ul>
                                        </li>
                                        <li><a id="button1" href="#">Options Master</a>
                                            <ul>
                                                <li class="<?= ($route=='admin/options/create') ? "active" : "" ?>"><a href="{{url('/admin/options/create')}}">Add options</a></li>
                                                <li class="<?= ($route=='admin/options/index') ? "active" : "" ?>"><a href="{{url('/admin/options/index')}}">View All</a></li>
                                            </ul>
                                        </li>
                                        <li><a id="button1" href="#">Reports</a>
                                            <ul>
                                                <li class="<?= ($route=='admin/reports') ? "active" : "" ?>"><a href="{{url('/admin/reports')}}">Deals List</a></li>
                                                <li class="<?= ($route=='admin/salereport') ? "active" : "" ?>"><a href="{{url('/admin/salereport')}}">Deal Sale</a></li>
                                                <li class="<?= ($route=='admin/transaction-history') ? "active" : "" ?>"><a href="{{url('/admin/transaction-history')}}">Transaction History</a></li>
                                            </ul>
                                        </li>
