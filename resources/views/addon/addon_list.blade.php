                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="table_data" class="result_append">
                            @include('addon.addon_row', ['addon' => $addon])
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Addon Detail</h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", "input[name=user_status]", function() {
                ...
                $.get("<?= url('addon/active-inactive') ?>" + "/" + attrfr, function(data) {
            ...
            $(document).on("click", ".openDetailModal", function() {
                start_loader()
                var attrfr = $(this).attr("eid");
                $.get("<?= url('addon/show') ?>" + "/" + attrfr, function(data) {
            ...
            $(document).on("blur", ".search", function() {
                ...
                start_loader();
                $.get("<?= url('addon/search') ?>", searchParams, function(data) {
            ...
            function fetch_data(page) {
                ...
                start_loader();
                $.ajax({
                    url: "<?= url('/addon/search?page=') ?>" + page,
                    type: "GET",
                    data: searchParams,
